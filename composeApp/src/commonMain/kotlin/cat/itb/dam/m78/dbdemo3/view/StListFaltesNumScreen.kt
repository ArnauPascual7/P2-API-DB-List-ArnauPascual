...
fun StudentsListWithFaltes() {
    ...
    if (apiStudents != null && dbStudents != null) {
        Column(
            ...
            Text("Estudiants i Faltes", Modifier.padding(10.dp),fontSize = 30.sp, fontWeight = FontWeight.Bold, textAlign = TextAlign.Center)
            ...
            LazyColumn(
                ...
                apiStudents.forEach { student ->
                    item {
                        val faltes = dbStudents.count { st -> st.studentId.toInt() == student.id }
                        Column(
                            Modifier.fillMaxSize(),
                            horizontalAlignment = Alignment.CenterHorizontally
                        ) {
                            ...
                            if (faltes > 0) Text("$faltes Faltes", Modifier.padding(top = 10.dp))
                            Button(
